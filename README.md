...
Özgün Lumrea kimliğiyle hazırlanmış tam kapsamlı kozmetik mağazası, sipariş akışı, yönetim paneli ve Firebase kullanmayan Cloudflare veri katmanı.
...
Pages yayın kaynağı `main /(root)` dalıdır: kök dizindeki site her push'ta otomatik yayınlanır. Kaynak dosyalar `github-pages/` klasöründedir ve kök kopyayla birebir aynı tutulur (`npm test` bunu doğrular).
...
Sol üstteki Lumrea logosuna 1,6 saniye içinde beş kez tıklayın.
